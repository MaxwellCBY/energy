...
def General_info():
    ...
    # Load data safely
    try:
        folder_path = 'ccusdata/ccus_projects.xlsx'
    ...
    st.subheader(f"There are {len(df)} projects in the current association.")
...
def platform_AI():
    ...
    # Load content
    default_question = load_text('questions_ccus/default_question.txt')
